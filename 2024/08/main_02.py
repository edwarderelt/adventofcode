            ...
            for k in range(len(matrix)):
                for l in range(len(matrix[k])):
                    ...
                    if matrix[k][l] == matrix[i][j]:
                        ...
                        new_i_1 = i - vector_i
                        new_j_1 = j - vector_j
                        while new_i_1 >= 0 and new_j_1 >= 0 and new_i_1 < len(matrix) and new_j_1 < len(matrix[0]):
                            result_matrix[new_i_1][new_j_1] = 1
                            new_i_1 -= vector_i
                            new_j_1 -= vector_j
                        new_i_2 = k + vector_i
                        new_j_2 = l + vector_j
                        while new_i_2 >= 0 and new_j_2 >= 0 and new_i_2 < len(matrix) and new_j_2 < len(matrix[0]):
